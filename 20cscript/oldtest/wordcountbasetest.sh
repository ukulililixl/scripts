...
RES=/home/ncsgroup/xiaolu/hadoopctdrlogs/wordcountlogs/res_${K}_${M}_${BLOCKSIZE}_${USECTDR}_${POLICY}_${RUN}
...
# 12 start grep
echo "start $i wordcount" >>$RES
JAR=/home/ncsgroup/xiaolu/hadoop-20-ctdr/build/hadoop-0.20-examples.jar
hadoop jar $JAR wordcount raidTest/input1 output$i >>$RES 2>&1
echo "stop $i wordcount" >>$RES
stop-mapred.sh
done

# 15 backup logs
HADOOPLOG=/home/ncsgroup/xiaolu/hadoopctdrlogs/wordcountlogs
...
ssh cloud-node$i "cp -r /home/ncsgroup/CTDR/output ${CTDRLOG}/wordcountoutput_${K}_${M}_${BLOCKSIZE}_${USECTDR}_${POLICY}_${RUN}"
done 
