...
RES=/home/ncsgroup/xiaolu/hadoopctdrlogs/hadooplogs/res_${K}_${M}_${BLOCKSIZE}_${USECTDR}_${POLICY}_${RUN}
HADOOPHOME=/home/ncsgroup/xiaolu/hadoop-20-ctdr

echo "start k=$K m=$M blocksize=${BLOCKSIZE}MB usectdr=$USECTDR policy=$POLICY for the $RUN time" >$RES
date >>$RES
...
BASIC=/home/ncsgroup/xiaolu/inputfile/block_${BLOCKSIZE}_${K}
echo "basic file is $BASIC" >>$RES
TIMES=1
echo "write into hdfs for $TIMES times" >>$RES
for((i=1;i<=${TIMES};i++))
do
    hadoop dfs -put $BASIC raidTest/input$i
done
...
ssh cloud-node12 "/home/ncsgroup/xiaolu/CTDR/test.sh $K $M $POLICY $nodeid"
...
# 15 backup logs
HADOOPLOG=/home/ncsgroup/xiaolu/hadoopctdrlogs/hadooplogs
...
ssh cloud-node$i "cp -r /home/ncsgroup/CTDR/output ${CTDRLOG}/output_${K}_${M}_${BLOCKSIZE}_${USECTDR}_${POLICY}_${RUN}"
done 
